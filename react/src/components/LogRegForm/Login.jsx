...
import {
    setTouchedFalseLogin,
    setTouchedTrueLogin,
} from "../../functions/setTouched";
    ...
    return (
        <div className={styles.bg}>
            ...
            <div className={`${styles.container} ${styles.container_bg}`}>
                ...
                <button
                    className={`${styles.box} ${styles.google} ${styles.btn}`}
                >
                ...
                <form className={styles.form} onSubmit={handleSubmit}>
                    <p
                        className={`${styles.text_smaller} ${styles.input_title}`}
                    >
                    ...
                    <InputRounded
                        ...
                        value={password}
                        onChange={(e) =>
                            passwordInputChangeHandler(e, setPassword)
                        }
                        type="password"
                        placeholder="Hasło"
                    />
                    ...
                    <div className={styles.footer}>
                        <div className={styles.checkbox}>
                            ...
                            <label htmlFor="task-1">
                                ...
                                <span className={styles.text_smaller}>
                                    Zapamiętaj mnie
                                </span>
                            </label>
                        </div>
                        <button
                            className={`${styles.text_bigger} ${styles.submit} ${styles.box} ${styles.btn}`}
                            type="submit"
                        >
                            Zaloguj się
                        </button>
